...
create_clock -period 8.000 -name adc_clk -waveform {0.000 4.000} -add [get_ports {adc_clk_i[1]}]
create_generated_clock -name ser_clk [get_pins i_pll/pll/CLKOUT0]
...
# create_generated_clock -name {clk_div_reg[15]} -source [get_pins pll/pll/CLKOUT0] -divide_by 65536 [get_pins {clk_div_reg[15]/Q}]
...
# set_output_delay -clock [get_clocks dac_sel_o] -clock_fall -min -add_delay 1.600 [get_ports {dac_dat_o[*]}]
# set_output_delay -clock [get_clocks dac_sel_o] -clock_fall -max -add_delay 3.600 [get_ports {dac_dat_o[*]}]
# set_output_delay -clock [get_clocks dac_sel_o] -min -add_delay 1.600 [get_ports {dac_dat_o[*]}]
# set_output_delay -clock [get_clocks dac_sel_o] -max -add_delay 3.600 [get_ports {dac_dat_o[*]}]
# set_output_delay -clock [get_clocks dac_sel_o] -clock_fall -min -add_delay 1.600 [get_ports dac_rst_o]
# set_output_delay -clock [get_clocks dac_sel_o] -clock_fall -max -add_delay 3.600 [get_ports dac_rst_o]
# set_output_delay -clock [get_clocks dac_sel_o] -min -add_delay 1.600 [get_ports dac_rst_o]
# set_output_delay -clock [get_clocks dac_sel_o] -max -add_delay 3.600 [get_ports dac_rst_o]
# set_clock_groups -asynchronous -group [get_clocks pll_adc_clk] -group [get_clocks {clk_div_reg[15]}]
#set_clock_groups -asynchronous -group [get_clocks {clk_div_reg[15]}] -group [get_clocks pll_dac_clk_1x]




#set_false_path -from [get_clocks clk_fpga_1] -to [get_clocks pll_dac_clk_1x]
#set_false_path -from [get_clocks clk_fpga_0] -to [get_clocks clk_fpga_1]
#set_false_path -from [get_clocks pll_adc_clk] -to [get_clocks clk_fpga_1]
